...
//        if (!getCourseSession().contains(courseSession)) {
//        	getCourseSession().add(courseSession);
//            if (courseSession.getTeacher() != null) {
//            	courseSession.getTeacher().getCourseSession().remove(courseSession);
//            }
